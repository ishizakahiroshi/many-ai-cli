...
> Ngày 2026-08-13 đã xem xét lại dựa trên «phương thức host nông» của Spotify Xirp nhưng **giữ nguyên chính sách** (hồ sơ tạm hoãn: `docs/local/pending_gemini-shallow-host-option.md`). Không lấy việc các hãng khác hỗ trợ Gemini, hay số lượng provider trông kém hơn, làm căn cứ để đề xuất bắt tay làm.
