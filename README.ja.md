...
リリースページから `any-ai-cli-<version>-windows-x64.zip` をダウンロードし、`any-ai-cli-wsl.exe` を展開して Windows の PATH が通っている場所に置きます。
...
リリースページから `any-ai-cli-<version>-linux-x64.zip` をダウンロードし、`any-ai-cli` を展開して WSL 内の PATH が通っている場所に置きます。
