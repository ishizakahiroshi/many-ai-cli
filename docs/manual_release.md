...
- `any-ai-cli-<version>-windows-amd64.zip`
...
- `docs/v0.1.x-any-ai-cli-design.md` / `CLAUDE.md`（記述上の参照）
...
- `docs/v0.1.x-any-ai-cli-design.md` / `CLAUDE.md`：プロセ的な参照は手動。CHANGELOG 系へリンクする形へ切り替える検討
